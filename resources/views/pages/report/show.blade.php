<x-admin-layout>
            ...
            <div class="page-header-content d-lg-flex">
                <div class="d-flex">
                    <h4 class="mb-0 page-title">
                        Danh sách nhóm - <span class="fw-normal">Báo cáo</span>
                    </h4>
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="py-2 breadcrumb">
                        <a href="{{ route('admin.reports.index') }}" class="breadcrumb-item"><i class="ph-house"></i></a>
                        <a href="{{ route('admin.reports.index') }}" class="breadcrumb-item active">Đợt đăng ký</a>
    ...
    <div class="content">
        <livewire:report.report-show :campaignId="$campaign->id"/>
    </div>
</x-admin-layout>

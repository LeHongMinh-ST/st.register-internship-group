<x-admin-layout>
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="py-2 breadcrumb">
                        <a href="{{ route('admin.topics.index') }}" class="breadcrumb-item"><i class="ph-house"></i></a>
                        <a href="{{ route('admin.topics.index') }}" class="breadcrumb-item active">Đợt đăng ký</a>
                        <span class="breadcrumb-item active">Danh sách hướng đề tài</span>
                    </div>
    ...
    <div class="content">
        <livewire:topic.topic-show :campaignId="$campaign->id"/>
    </div>
</x-admin-layout>

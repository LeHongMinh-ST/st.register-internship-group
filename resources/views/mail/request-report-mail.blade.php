...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Hệ thống đã nhận được yêu cầu nộp báo cáo TTCN/KLTN của bạn.</p>
        <p>Vui lòng nhấn vào nút bên dưới để nộp báo cáo:</p>
        <a href="{{ $link }}" class="button">Nộp báo cáo</a>

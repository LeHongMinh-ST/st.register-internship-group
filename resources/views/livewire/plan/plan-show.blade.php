    ...
    <div class="card">
        <div class="py-3 card-header d-flex justify-content-between align-items-center">
            <div class="gap-2 d-flex">
                <div>
                    <a href="{{ route('admin.plans.index') }}"><h6 class="fw-semibold text-primary">{{$plan?->name}}</h6></a>
        ...
        <div class="table-responsive-md">
            <table class="table fs-table">
                ...
                @forelse($planDetails as $planDetail)
                    <tr>
                        <td>{{ $loop->index + 1 + $planDetails->perPage() * ($planDetails->currentPage() - 1) }}</td>
                        <td>
                            @if($planDetail->time)
                        ...
                        <td class="text-center">
                            <div class="dropdown ">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{ route('admin.plans.editPlanDetail', $planDetail->id) }}" class="dropdown-item">
                                        <i class="ph-note-pencil px-1"></i>
                                        Chỉnh sửa
                                    </a>
                                    <a type="button" wire:click="openPlanDetailModal({{ $planDetail->id }})" class="dropdown-item text-danger">

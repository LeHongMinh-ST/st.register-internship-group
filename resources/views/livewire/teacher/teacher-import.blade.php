    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Import thông tin giảng viên</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        ...
                        @enderror
                        <a class="cursor-pointer text-primary d-inline-block mt-2" target="_blank" 
                        href="{{route('admin.teachers.downloadTemplateTeacher')}}"
                        >Tải file mẫu</a>
                    </div>
                </div>
            </div>

            ...
            <div class="row login-row">
                <div class="col-12">
                    <div class="mb-3 text-center">
                        ...
                        <span class="d-block text-muted">Chỉnh sửa chính thức</span>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text"
                                                                           ...
                                                                           class="form-control" required>
                                                                    @error('dataStudent.'.$student?->code.'.supervisor_company')
                                                                    <label
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text"
                                                                           ...
                                                                           class="form-control" required>
                                                                    @error('dataStudent.'.$student?->code.'.supervisor_company_email')
                                                                    <label
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text"
                                                                           ...
                                                                           class="form-control" required>
                                                                    @error('dataStudent.'.$student?->code.'.supervisor_company_phone')
                                                                    <label

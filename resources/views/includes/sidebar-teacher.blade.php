        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="pt-0 nav-item-header">
                    <div class="opacity-50 text-uppercase fs-sm lh-sm sidebar-resize-hide">Quản lý nhóm sinh viên</div>
                ...
                <li class="pt-0 nav-item-header">
                    <div class="opacity-50 text-uppercase fs-sm lh-sm sidebar-resize-hide">Quản lý đề tài</div>
                    <i class="ph-dots-three sidebar-resize-show"></i>
                </li>
                <li class="nav-item">
                    <a href="{{ route('teacher.topics') }}"
                       class="nav-link {{ request()->routeIs('teacher.topics') ? 'active' : '' }}">
                        <i class="ph-code"></i>
                        <span>Đề tài TTNN & KLTN</span>
                    </a>
                </li>
